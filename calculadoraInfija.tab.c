...
#line 9 "calculadoraInfija.y"
{
	float numeroDecimal;
}
/* Line 193 of yacc.c.  */
#line 115 "calculadoraInfija.tab.c"
	YYSTYPE;
...
/* Line 216 of yacc.c.  */
#line 128 "calculadoraInfija.tab.c"
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 32 "calculadoraInfija.y"
    { printf ("\t %f\n", (yyvsp[(1) - (2)].numeroDecimal)); ;}
    break;

  case 6:
#line 35 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = (yyvsp[(1) - (1)].numeroDecimal);         ;}
    break;

  case 7:
#line 36 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = (yyvsp[(1) - (3)].numeroDecimal) + (yyvsp[(3) - (3)].numeroDecimal);    ;}
    break;

  case 8:
#line 37 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = (yyvsp[(1) - (3)].numeroDecimal) - (yyvsp[(3) - (3)].numeroDecimal);    ;}
    break;

  case 9:
#line 38 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = (yyvsp[(1) - (3)].numeroDecimal) * (yyvsp[(3) - (3)].numeroDecimal);    ;}
    break;

  case 10:
#line 39 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = (yyvsp[(1) - (3)].numeroDecimal) / (yyvsp[(3) - (3)].numeroDecimal);    ;}
    break;

  case 11:
#line 40 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = -(yyvsp[(2) - (2)].numeroDecimal);        ;}
    break;

  case 12:
#line 41 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = pow ((yyvsp[(1) - (3)].numeroDecimal), (yyvsp[(3) - (3)].numeroDecimal)); ;}
    break;

  case 13:
#line 42 "calculadoraInfija.y"
    { (yyval.numeroDecimal) = (yyvsp[(2) - (3)].numeroDecimal);         ;}
    break;


/* Line 1267 of yacc.c.  */
#line 1373 "calculadoraInfija.tab.c"
      default: break;
    }
